...
class PolicyMakeCommand extends EnvironmentCommand
{
     ...
     * @var string
     */
    protected $signature = 'impersonate:make-policy {name} {--app} {--group}
                            {--app_id= : The id of the app}
                            {--group_id= : The id of the group}
                            {--tenant_id= : The id of the tenant}';
    protected $lib       = 'policy';
     ...
     * @var string
     */
    protected $description = 'This command is create policy or trait in impersonate application.';
